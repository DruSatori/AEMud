...
/*
 * Should we inherit /secure/auto.c int all objects?
 *
 */
#define USE_AUTO_OBJ

/*
 * Allow hiding of host information
 */
#define HIDE_HOST_HACK "../hidden"
 ...
 * the swap algorithm
 */
#define MAX_CONSECUTIVE_SWAPS	1
 ...
 */
#define EVALUATOR_STACK_SIZE	3000
 ...
 */
#define COMPILER_STACK_SIZE	3000
