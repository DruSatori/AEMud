 ...
 *                start: The line to start indenting on. (Max 100)
 * Returns:       A string with newline separated strings
 */
char *
break_string(char *str, int width, struct svalue *indent, int start)
{
    char 	*fstr, *istr;
    struct 	vector *lines;
    ...
    /* Calculate the line to begin indenting on. */
